...
const resetPasswordMessage = (verificationToken) => {
  return `<!DOCTYPE html>
  <html>
    <head>
      <style>
    ...
    <body>
      <div class="container">
        ...
        <p>Oops you forgot your password!.
        <br/> Click this link to reset your password <a href=${process.env.BASE_URL}/api/v1/auth/reset-password?token=${verificationToken}>Verify Email</a>. Thank you
        </p>
      </div>
    </body>
  </html>
